...
|---------------|--------------------|----------------------------------------------------------------------|
| 0x0000–0x07FF | КС573РФ2/ROM N1    | Main program (keyboard handling, modes, display control, core logic) |
| 0x0800–0x0FFF | КР537РУ10/RAM      | System variables, flags, buffers, stack, temporary data              |
...
| 0x3000–0x37FF | КС573РФ2/ROM N2    | Sound data, waveforms, rhythm tables, or additional code             |
| 0x3800–0x3FFF | КС573РФ2/ROM N3    | Extra code, lookup tables, or sequencer support                      |
